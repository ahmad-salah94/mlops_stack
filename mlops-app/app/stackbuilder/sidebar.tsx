import { FileStack, Home, Package, Component, Notebook, Wrench, Percent, Castle, AudioLines } from "lucide-react"
        ...
        <div className="flex flex-col items-center w-64 h-screen pt-4 overflow-hidden text-gray-700 bg-gray-100 rounded">
            ...
            <div className="w-full px-2">
                <div className="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                    ...
                    <Link href="/stackbuilder" className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
                        <FileStack />
                    ...
                    <Link href="/podcast" className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
                        <AudioLines />
                        <span className="ml-2 text-sm font-medium">podcast about MLOps</span>
                    </Link>
                </div>
            </div>
